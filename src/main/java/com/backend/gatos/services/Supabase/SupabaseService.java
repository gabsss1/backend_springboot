package com.backend.gatos.services.Supabase;
...
public class SupabaseService {
    ...
    public String uploadImage(String locacion, MultipartFile file) throws IOException {
        ...
        int randomSuffix = (int) (Math.random()*1_00000000);
        ...
        String uniqueFileName = sanitizedFileName + "" + randomSuffix + fileExtension;
